...
- **test_art_mode_invalid_style_rejected_without_side_effects()** (2 connections) — `backend/test_handwriting_validation.py`
- **test_art_mode_invalid_style_rejected_without_side_effects()** (2 connections) — `test/test_handwriting_validation.py`
- **Art Mode khi truyền style sai định dạng hoặc ngoài enum (kể cả style…** (1 connections) — `test/test_handwriting_validation.py`
