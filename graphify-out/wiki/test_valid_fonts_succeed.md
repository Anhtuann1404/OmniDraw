...
- **test_valid_fonts_succeed()** (2 connections) — `backend/test_handwriting_validation.py`
- **test_valid_fonts_succeed()** (2 connections) — `test/test_handwriting_validation.py`
- **Tất cả các font trong RENDER_PROFILES với letter_type=general đều phải render…** (1 connections) — `test/test_handwriting_validation.py`
