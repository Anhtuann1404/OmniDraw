...
- **test_style_null_or_invalid_type_structured_error()** (2 connections) — `backend/test_handwriting_validation.py`
- **test_style_null_or_invalid_type_structured_error()** (2 connections) — `test/test_handwriting_validation.py`
- **style = null hoặc sai datatype trong request handwriting phải trả structured…** (1 connections) — `test/test_handwriting_validation.py`
