...
- **test_explicit_font_null_or_invalid_type_rejected()** (2 connections) — `backend/test_handwriting_validation.py`
- **test_explicit_font_null_or_invalid_type_rejected()** (2 connections) — `test/test_handwriting_validation.py`
- **Truyền key 'font' nhưng value là null hoặc sai kiểu dữ liệu phải trả lỗi…** (1 connections) — `test/test_handwriting_validation.py`
