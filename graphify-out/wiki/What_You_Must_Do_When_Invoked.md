...
- **test_invalid_font_rejected()** (2 connections) — `backend/test_handwriting_validation.py`
- **test_invalid_font_rejected()** (2 connections) — `test/test_handwriting_validation.py`
- **Font không nằm trong RENDER_PROFILES phải trả lỗi UNSUPPORTED_FONT.** (1 connections) — `test/test_handwriting_validation.py`
