...
- **test_seed_determinism()** (2 connections) — `backend/test_handwriting_validation.py`
- **test_seed_determinism()** (2 connections) — `test/test_handwriting_validation.py`
- **Cùng text và cùng seed phải cho metrics giống nhau hoàn toàn.** (1 connections) — `test/test_handwriting_validation.py`
