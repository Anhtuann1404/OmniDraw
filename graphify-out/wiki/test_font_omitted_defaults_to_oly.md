...
- **test_font_omitted_defaults_to_oly()** (2 connections) — `backend/test_handwriting_validation.py`
- **test_font_omitted_defaults_to_oly()** (2 connections) — `test/test_handwriting_validation.py`
- **Nếu không truyền font trong options, hệ thống dùng default 'oly' và chạy thành…** (1 connections) — `test/test_handwriting_validation.py`
