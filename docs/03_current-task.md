...
| :--- | :--- | :--- | :--- |
| **TV4 — Project Lead & Handwriting / CA-VHC Composition Lead** | Hoàn tất Strict Validation, BƯỚC A/B, PR1, Pre-PR3 Acceptance Contract, khóa Hợp đồng E4 cùng TV2; hoàn thành PR3 Slice 1 (types bất biến, candidate generation, 10/10 tests PASS, full suite 150/150 passed) | Không | 🟢 PR3 Slice 1 hoàn thành, chuẩn bị Slice 2/3 |
...
- [ ] **BƯỚC C / PR3 — CA-VHC Diacritic-Aware Trellis DAG (TV4 lead, TV2 phối hợp):** Triển khai `CompositionState = (GlyphVariant, DiacriticCandidate)`, tích hợp kiểm tra va chạm dấu tiếng Việt vào Trellis DAG recurrence và dynamic diacritic placement. *(Trạng thái: `IN_PROGRESS` — Đã hoàn tất Slice 1: tạo `backend/handwriting/composition.py` với đầy đủ types bất biến, candidate generation, internal collision/clearance, local-to-world transform helper và `tests/test_ca_vhc_composition_state.py` đạt 10/10 automated tests PASS; toàn bộ suite đạt 150/150 passed; tiếp theo là Slice 2/3)*.
