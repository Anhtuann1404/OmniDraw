...
| :--- | :--- | :--- | :--- |
| **TV4 — Project Lead & Handwriting / CA-VHC Composition Lead** | Hoàn tất PR3 (Diacritic-Aware Trellis DAG): Slices 1–5 đã hoàn thành, tích hợp Viterbi Bellman DP diacritic-aware, bridge collision against diacritics, engine rendering không duplicate dấu; 18/18 tests PR3 PASS, full suite 158/158 tests PASS | Không | 🟢 Hoàn thành PR3 |
...
- [x] **✅ BƯỚC C / PR3 — CA-VHC Diacritic-Aware Trellis DAG hoàn thành (TV4 lead, TV2 phối hợp):** Triển khai toàn diện 5 slices theo Hợp đồng E4 và đặc tả thiết kế:
