...
| :--- | :--- | :--- | :--- | ---: | :--- |
| TV1 | `NOT_STARTED` | `PENDING` | `PENDING_CHECKPOINT_COMMIT` | PENDING | PENDING |
| TV2 | `NOT_STARTED` | `PENDING` | `PENDING_CHECKPOINT_COMMIT` | PENDING | PENDING |
| TV3 | `NOT_STARTED` | `PENDING` | `PENDING_CHECKPOINT_COMMIT` | PENDING | PENDING |
